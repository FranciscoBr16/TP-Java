<%@page import="entities.Usuario"%> <%@ page language="java"
...
<html lang="es">
    <head>
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="/GYM/style/estilosGenerales.css"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="/GYM/style/estilosGenerales2.css"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="/GYM/style/formularioEstilos.css"
        />
        <link
            rel="stylesheet"
        ...
        <div class="contenedor">
            <div class="formulario">
                <div class="headerForm">
                    <p class="titulo">
                        Crear un nuevo <span class="anaranjado">abono</span>
                    </p>
                </div>
                <hr />
                <form
                    action="/GYM/SvAltaAbono"
                    method="POST"
                ...
                >
                            ...
                            <label class="tipo-opcion" for="esMensualSi">
                                ...
                                <div class="tipo-contenido">
                                    <div class="tipo-icono">
                                        <i class="bi bi-calendar-month"></i>s
                                    </div>
                    ...
                    <div class="campo">
                        ...
                        <input
                            type="text"
                            name="nombreAbono"
                            placeholder="Ej: Plan Premium, Pack 5 Clases"
                            required
                        />
                    </div>
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const checked = document.querySelector(
                    'input[name="esMensual"]:checked',
                );
                if (checked) {
                    checked.closest(".tipo-opcion").style.borderColor =
                        "#d95126";
                    checked.closest(".tipo-opcion").style.backgroundColor =
                        "#fff5f2";
                }
            });
        </script>
